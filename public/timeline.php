...
<div>現在 <?= htmlspecialchars($user['name']) ?> さんでログイン中</div>
...
<dl id="entryTemplate" style="display: none; margin-bottom: 1em; padding-bottom: 1em; border-bottom: 1px solid #ccc;">
  <dt>番号</dt><dd data-role="entryIdArea"></dd>
  <dt>投稿者</dt>
  <dd>
  ...
  <dt>日時</dt><dd data-role="entryCreatedAtArea"></dd>
  <dt>内容</dt><dd data-role="entryBodyArea"></dd>
</dl>
